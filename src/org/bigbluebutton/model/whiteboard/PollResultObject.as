...
package org.bigbluebutton.model.whiteboard
{
  ...
  import org.bigbluebutton.model.whiteboard.AnnotationObject;
  ...
  public class PollResultObject extends DrawObject {
    ...
    private function drawRect(a:AnnotationObject, parentWidth:Number, parentHeight:Number, zoom:Number):void {
    ...
    override public function draw(a:AnnotationObject, parentWidth:Number, parentHeight:Number, zoom:Number):void {
      var ao:Object = a.annotation.shapes == null ? a.annotation.shape : a.annotation.shapes;
      ...
      for (var j:int = 0; j < answers.length; j++) {
		  ...
		  var localizedKey: String = ResourceManager.getInstance().getString('resources', 'polling.answer.' + ar.key);
		  
		  if (localizedKey == null || localizedKey == "" || localizedKey == "undefined") {
			  localizedKey = ar.key;
		  } 
	      var rs:Object = {a: localizedKey, v: ar.num_votes as Number};
	      trace("poll result a=[{0}] v=[{1}]", [ar.key, ar.num_votes]);
	      ans.push(rs);
      }
    ...
    override public function redraw(a:AnnotationObject, parentWidth:Number, parentHeight:Number, zoom:Number):void {
